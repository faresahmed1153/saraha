...
export default function Profile() {
  ...
  async function getProfile() {
    const { data } = await axios.get("https://saraha-api.fly.dev/Myprofile", {
  ...
  async function sendData(e) {
    ...
    if (result.error) {
      ...
      const { data } = await axios.patch("https://saraha-api.fly.dev/updateProfile", currentUser, {
        headers: { authorization: `Bearer ${token}` },
      });
      console.log(data);
      if (data.message === "Done") {
        ...
        <div className="row justify-content-center align-items-center flex-column vh-100  ">
          <div className="col-md-5 mt-5 ">
            <div className="d-flex justify-content-center align-items-center flex-column">
              ...
              <img className="rounded mb-2" src={`https://saraha-api.fly.dev/${profile.profilePic}`} alt="profilepicture" />
            </div>
