...
export default function Profile() {
  ...
  async function getProfile() {
    const { data } = await axios.get("https://lit-caverns-07639.herokuapp.com/Myprofile", {
  ...
  async function sendData(e) {
    ...
    if (result.error) {
      ...
      const { data } = await axios.patch("https://lit-caverns-07639.herokuapp.com/updateProfile", currentUser, {
        headers: { authorization: `Bearer ${token}` },
      });
      console.log(data);
      if (data.message === "Done") {
        ...
        <div className="row justify-content-center align-items-center flex-column vh-100  ">
          <div className="col-md-5 mt-5 ">
            <div className="d-flex justify-content-center align-items-center flex-column">
              ...
              <img className="rounded mb-2" src={`https://lit-caverns-07639.herokuapp.com/${profile.profilePic}`} alt="profilepicture" />
            </div>
